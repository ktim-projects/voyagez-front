      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div class="flex space-x-3">
            ...
            <a 
              href="#" 
              class="group relative p-2.5 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-sky-500 dark:hover:bg-sky-500 transition-all duration-300 transform hover:scale-110 hover:shadow-lg"
              aria-label="Twitter"
            >
              <svg class="h-5 w-5 text-gray-600 dark:text-gray-400 group-hover:text-white transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
