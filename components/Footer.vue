      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="hover:text-red-600 dark:hover:text-red-500"><i class="pi pi-facebook"></i></a>
            <a href="#" class="hover:text-red-600 dark:hover:text-red-500"><i class="pi pi-twitter"></i></a>
            <a href="#" class="hover:text-red-600 dark:hover:text-red-500"><i class="pi pi-instagram"></i></a>
          </div>
        </div>
      </div>
    </div>
